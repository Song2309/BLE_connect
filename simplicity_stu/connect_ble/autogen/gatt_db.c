...
{
  0xfd, 0xcc, 0x07, 0x12, 0xd0, 0x7e, 0x95, 0xb5, 0x8c, 0x46, 0x6d, 0x87, 0x4b, 0x63, 0x10, 0x37, 
  0x52, 0x5b, 0xd0, 0xc1, 0xd7, 0x65, 0x4e, 0x8d, 0x0e, 0x42, 0x67, 0x1a, 0x31, 0x0f, 0x08, 0x23, 
...
GATT_DATA(const sli_bt_gattdb_value_t gattdb_attribute_field_24) = {
  .len = 16,
  .data = { 0x32, 0x5a, 0x31, 0x29, 0x01, 0xcf, 0xe9, 0xb0, 0xe7, 0x46, 0xba, 0x67, 0x1c, 0xb0, 0x63, 0xdf, }
};
...
GATT_DATA(sli_bt_gattdb_attribute_chrvalue_t gattdb_attribute_field_10) = {
  .properties = 0x0a,
  .max_len = 13,
  .data = { 0x53, 0x6f, 0x6e, 0x20, 0x54, 0x6f, 0x6e, 0x67, 0x00, 0x00, 0x00, 0x00, 0x00, },
};
...
GATT_DATA(const sli_bt_gattdb_attribute_t gattdb_attributes_map[]) = {
  ...
  { .handle = 0x1e, .uuid = 0x8001, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x07, .dynamicdata = NULL },
